...
class FalseSubclass(FalseC):
    """Subclass of 'False' representing the False as base object in SOL26."""

    def __init__(self) -> None:
        super().__init__(False)

    def constructor_new(self, args: list[Any] | None = None) -> Result | Object:
        """Return self — False singleton cannot be re-instantiated."""
        return self

    def constructor_from(self, args: list[Any] | None = None) -> Result | Object:
        """Return a default Object — False cannot be copied from another object."""
