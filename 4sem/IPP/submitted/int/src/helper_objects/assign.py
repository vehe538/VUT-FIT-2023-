...
from builtin_classes.builtin_false import FalseC, false
from builtin_classes.builtin_integer import Integer
from builtin_classes.builtin_nil import Nil, NilSubclass
from builtin_classes.builtin_object import Object
from builtin_classes.builtin_string import String
from builtin_classes.builtin_true import TrueC, true
        ...
        for parameter in self.current_root[0]:
            ...
            if parameter.tag == "parameter":
                ...
                if pname in params_names:
                    raise InterpreterError(
                        ErrorCode.SEM_ERROR, f"Formal block parameter '{pname}' collision deteced"
                    )
