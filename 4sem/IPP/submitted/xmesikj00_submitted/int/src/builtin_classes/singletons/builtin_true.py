...
class TrueSubclass(TrueC):
    """Subclass of 'True' representing the True as base object in SOL26."""

    def __init__(self) -> None:
        super().__init__(False)

    def constructor_new(self, args: list[Any] | None = None) -> Result | Object:
        """Return self — TrueSubclass cannot be re-instantiated."""
        return self

    def constructor_from(self, args: list[Any] | None = None) -> Result | Object:
        """Return a default Object — TrueSubclass cannot be copied from another object."""
