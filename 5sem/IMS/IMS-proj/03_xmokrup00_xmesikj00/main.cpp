...
int tFrekvenciaObjednavok;
int pocetZberacov = 3;
int tPozbieranieHriadky; // kolko Zberacovi trva pozbierat jednu hriadku
int pocetRastlinHriadka; // pocet rastlin v jednej hriadke

Facility Driver("Vodic na trase plantaz-stanovisko1");
int plantCounter;
int tNalozenieRastlinyImport; // nalozenie jednej rastliny
int kapacitaAutaImport = 100; // po nalozeni 60tich rastlin, driver odchadza
int tCasCesty;  // cas cesty pole - s1
...
void setOptionsDefault() {
    ...
    // VVVVVVVV Handler
    tHandle = 10*60; // cas obsluhy handlera

    // VVVVVVVV Odpad
    Trash_capacity = 50; // kapacita odpadu
    ...
    pocetZberacov = 4;
    Zberaci.SetCapacity(pocetZberacov);

    // VVVVVVVV Driver + Cesta na S1
    tNalozenieRastlinyImport = 10;
    kapacitaAutaImport = 100;
    NavesKamionu.SetCapacity(kapacitaAutaImport);
    tCasCesty = 2460;

    // VVVVVVVV Stanoviste 1 Takt
    pocetPracovnikuS1 = 1;
    tTakt = 60; // takt pro stanoviste 1 (aby stihalo stanoviste 2)

    // VVVVVVVV Stanoviste 2 Blistry
    pocetPracovnikuS2 = 2;
    Stanoviste2.SetCapacity(pocetPracovnikuS2);
    ItemsS2_max = 50;
    ...
    pocetPracovnikuS3 = 1;
    Stanoviste3.SetCapacity(pocetPracovnikuS3);
    ItemsS3_max = 25;
    SanceNaChybuS3 = 0.01; // 1% sance na chybu na stanovisti 3
    UspechZpracovaniS3 = 0.90; // 90%
    tZpracovaniS3 = 2.5*60.0;

    // VVVVVVVV Auto Export
    tPrijezduAutaExport = 60*60*1; // perioda příjezdu aut
    kapacitaAutaExport = 16;
    tNaklozeniRostlinyExport = 110; // cas nalozeni 1 rostliny ("opatrne naklada")
}

void setOptionsDoubleWorkerst() {
...
void setOptionsBadMonth() {
    ...
    Stanoviste2.SetCapacity(pocetPracovnikuS2);
    ItemsS2_max = 50;
    SanceNaChybuS2 = 0.25; // 2% sance na chybu na stanovisti 2
    UspechZpracovaniS2 = 0.9; // 90%
    tZpracovaniS2 = 5.0*60.0;
    ...
    // VVVVVVVV Auto Export
    tPrijezduAutaExport = 60*60*3; // perioda příjezdu aut
    kapacitaAutaExport = 100;
    tNaklozeniRostlinyExport = 110; // cas nalozeni 1 rostliny ("opatrne naklada")
}

void setOptionsBadMonthLessCars() {
    ...
    // VVVVVVVV Auto Export
    tPrijezduAutaExport = 60*60*4.10; // perioda příjezdu aut
    kapacitaAutaExport = 100;
    tNaklozeniRostlinyExport = 110; // cas nalozeni 1 rostliny ("opatrne naklada")
}

void setOptionsMoreOrders() {
    mistakesEnabled = false;
...
void setOptionsBiggerExportCars() {
    mistakesEnabled = false;
...
int main() {
    ...
    // zde zavolejte funkci, ktera nastavi parametry experimentu
    setOptionsDefault();
    mistakesEnabled = true;
    
    
    Init(0.0, 60*60*24*30);
